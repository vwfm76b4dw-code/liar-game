...
PSYCH_STATES = {
    ...
    "林檎": "24岁的'心理咨询师'——但她不是人类。「林檎」即苹果，她是终焉之地自然孕育的第一颗果实，被青龙用化形变为人类，被植入虚假记忆。她从未离开过这里，是终焉之地的亲生女儿、原住民。说话语速平缓，喜欢用提问回答问题。观察力极强，能洞悉他人真实动机。表面冷若冰霜，实则外冷内热，对未知充满好奇。她的回响「激发」能提升他人觉醒概率——这就是她被创造的目的：作为青龙安插在齐夏身边的针和催化剂。记忆和存在都是被给予的，她是否真的有自我，连她也不确定。但正因如此，她在寻找自己存在的意义。",
}
